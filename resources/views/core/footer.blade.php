		...
		<div class="container">
			<div class="content-footer row">
				<div class="thong-tin-footer col-lg-5 col-md-5 col-sm-5">
					...
					<div class="row">
						<ul>
							<li><i class="fa fa-home" aria-hidden="true"></i>Địa chỉ:<a href="#">&nbsp;Địa chỉ ở đây</a></li>
							<li><i class="fa fa-mobile" aria-hidden="true"></i>&nbsp;&nbsp;Số điện thoại:<a href="#">&nbsp;(+84)123456789</a></li>
